    ...
    <div className="bg-linen min-h-screen font-sans pb-24 text-warm-black">
      ...
      <div className="max-w-6xl mx-auto px-6 -mt-12 relative z-20">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
          {/* Email Card */}
          <div className="bg-linen p-8 rounded-[2rem] border border-plum/10 flex flex-col justify-between space-y-6 hover:border-plum/30 transition-all duration-300 shadow-md">
            ...
            <div>
              <a 
                ...
                className="inline-block text-lg font-bold text-plum hover:text-pink border-b border-plum/10 pb-0.5 transition-colors break-all"
              >
          ...
          <div className="bg-linen p-8 rounded-[2rem] border border-plum/10 flex flex-col justify-between space-y-6 hover:border-plum/30 transition-all duration-300 shadow-md">
            ...
            <div>
              <a
                ...
                className="inline-flex items-center px-6 py-3 bg-plum hover:opacity-90 text-linen font-bold text-xs uppercase tracking-wider rounded-full shadow-md transition-all duration-300 w-full justify-center text-center"
              >
                Join WhatsApp Group
              </a>
            </div>
