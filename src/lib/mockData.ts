...
export const mockStoreProducts: StoreProduct[] = [
  {
    id: 1,
    product_title: "Sanga Reconnect: Premium Cabin Upgrade (Couple)",
    slug: "reconnect-premium-cabin-couple",
    description: "Premium cabin accommodation at the retreat site, tailored for couples. Includes attached private bathroom, queen bed, and clean towels.",
    image: "https://images.squarespace-cdn.com/content/v1/55c3a641e4b01d44af64ae03/f1d1c411-95f8-4755-80a8-2afc7ffd537b/4.png",
    price: "$450",
    status: "available",
    external_checkout_url: "https://www.sangainitiative.org/tsi-reconnect-1/tsi-30-retreat-premium-cabin-6c2sg-2xdls",
    featured: true,
    published: true
  },
  {
    id: 2,
    product_title: "Sanga Reconnect: Premium Cabin Upgrade (Family)",
    slug: "reconnect-premium-cabin-family",
    description: "Premium cabin accommodation suited for families or shared booking of up to 4 members. Features twin beds, heater, and en-suite facilities.",
    image: "https://images.squarespace-cdn.com/content/v1/55c3a641e4b01d44af64ae03/24f4d1b2-d8b6-451a-9eb5-5d0fceca8616/3.png",
    price: "$600",
    status: "available",
    external_checkout_url: "https://www.sangainitiative.org/tsi-reconnect-1/tsi-30-retreat-premium-cabin-6c2sg",
    featured: true,
